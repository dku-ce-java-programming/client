    ...
    <div className="min-h-screen flex flex-col items-center justify-start bg-background">
      ...
      >
        ...
        <div className="flex items-center gap-4 mb-12">
          <img src="/globe.png" alt="Globe" className="w-12 h-12" />
          <span className="text-4xl font-semibold text-gray-800">교환학생 후기 검색</span>
        </div>

        {/* 로그인 섹션 */}
        <div className="w-full flex flex-col items-center">
          <h1 className="text-2xl font-semibold text-gray-800 mb-8">로그인</h1>
